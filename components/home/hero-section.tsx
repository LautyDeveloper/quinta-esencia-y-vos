...
const WHATSAPP_MESSAGE = "Hola! Me gustaría agendar una consulta de tarot/numerología."
...
function StarParticle({ delay, left, top, size }: { delay: number; left: string; top: string; size: number }) {
  return (
    <svg 
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="flex flex-col items-center group">
              <span className="text-3xl font-semibold text-foreground group-hover:text-primary transition-colors">+500</span>
